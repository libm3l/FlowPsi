...
- Adam Jirasek: Added External Solver Communication
...
through cosimulation engine. The cosimulation engine is a lsipdx utility\cite{Jirasek_2014}
...
If the two are not specifies, the flowPsi is compiled without the ability for communication with external solvers.
